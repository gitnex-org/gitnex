			...
			try {
				...
				if(!allowedReactions.isEmpty()) {
					...
					for(String allowedReaction : allowedReactions) {
						...
						@SuppressLint("InflateParams") MaterialCardView reactionButton = (MaterialCardView) LayoutInflater.from(context).inflate(R.layout.layout_reaction_button, root, false);
