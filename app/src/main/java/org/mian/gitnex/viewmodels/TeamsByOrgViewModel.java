...
public class TeamsByOrgViewModel extends ViewModel {
	...
	public LiveData<List<Team>> getTeamsByOrg(
			String orgName, Context ctx, TextView noDataTeams, ProgressBar mProgressBar) {
	...
	public void loadTeamsByOrgList(
			String orgName, Context ctx, TextView noDataTeams, ProgressBar mProgressBar) {

		Call<List<Team>> call =
				RetrofitClient.getApiInterface(ctx).orgListTeams(orgName, null, null);
