...
import org.mian.gitnex.adapters.ForgejoActionsRunnersAdapter;
 ...
 * @author mmarif
 */
public class RepositoryForgejoActionsRunnersFragment extends Fragment {

	private FragmentRepositoryActionsBinding binding;
	private RepositoryForgejoActionsViewModel viewModel;
	private ForgejoActionsRunnersAdapter adapter;
	...
	private void setupRecyclerView() {
		adapter = new ForgejoActionsRunnersAdapter(requireContext(), new ArrayList<>());
	...
	private void refreshData() {
		...
		viewModel.resetRunnersPagination();
		viewModel.fetchRunners(
