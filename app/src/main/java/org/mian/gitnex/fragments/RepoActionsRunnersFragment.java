...
import org.mian.gitnex.adapters.RepoActionsRunnersAdapter;
 ...
 * @author mmarif
 */
public class RepoActionsRunnersFragment extends Fragment {

	private FragmentRepositoryActionsBinding binding;
	private RepositoryActionsViewModel viewModel;
	private RepoActionsRunnersAdapter adapter;
	private RepositoryContext repository;

	public static RepoActionsRunnersFragment newInstance(RepositoryContext repository) {
		RepoActionsRunnersFragment fragment = new RepoActionsRunnersFragment();
	...
	public View onCreateView(
		...
		if (Boolean.FALSE.equals(viewModel.getHasLoadedRunnersOnce().getValue())) {
			refreshData();
		}
	...
	private void setupRecyclerView() {
		adapter = new RepoActionsRunnersAdapter(requireContext(), new ArrayList<>());
	...
	private void updateUiState() {
		...
		boolean loaded = Boolean.TRUE.equals(viewModel.getHasLoadedRunnersOnce().getValue());
	...
	private void refreshData() {
		viewModel.fetchRunners(requireContext(), repository.getOwner(), repository.getName(), true);
	}
