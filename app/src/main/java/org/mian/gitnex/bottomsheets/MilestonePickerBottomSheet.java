 ...
 * @author mmarif
 */
public class MilestonePickerBottomSheet extends BottomSheetDialogFragment {
	...
	public static MilestonePickerBottomSheet newInstance(
			RepositoryContext repo, List<String> current) {
		MilestonePickerBottomSheet f = new MilestonePickerBottomSheet();
