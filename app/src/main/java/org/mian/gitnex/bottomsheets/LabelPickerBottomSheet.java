 ...
 * @author mmarif
 */
public class LabelPickerBottomSheet extends BottomSheetDialogFragment {
	...
	public static LabelPickerBottomSheet newInstance(RepositoryContext repo, List<String> current) {
		LabelPickerBottomSheet f = new LabelPickerBottomSheet();
