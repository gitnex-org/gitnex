 ...
 * @author mmarif
 */
public class NotificationsFilterBottomSheet extends BottomSheetDialogFragment {
	...
	public static NotificationsFilterBottomSheet newInstance(
			String currentMode, boolean canMarkRead) {
		NotificationsFilterBottomSheet fragment = new NotificationsFilterBottomSheet();
