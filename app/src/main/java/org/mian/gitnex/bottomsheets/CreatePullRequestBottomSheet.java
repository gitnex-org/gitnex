 ...
 * @author mmarif
 */
public class CreatePullRequestBottomSheet extends BottomSheetDialogFragment {
	...
	public static CreatePullRequestBottomSheet newInstance(
		...
		CreatePullRequestBottomSheet fragment = new CreatePullRequestBottomSheet();
		...
		binding.btnBookmark.setIconTint(
				ColorStateList.valueOf(
						MaterialColors.getColor(
								requireContext(),
								isBookmarked ? R.attr.colorError : R.attr.iconsColor,
								0)));
		...
		binding.btnBookmark.setOnClickListener(
				v -> {
					...
					BookmarkHelper.toggleBookmark(
							...
							null,
							null,
							getString(R.string.create_pr) + " · " + repoContext.getFullName(),
					...
					binding.btnBookmark.setIconTint(
							ColorStateList.valueOf(
									MaterialColors.getColor(
											requireContext(),
											nowBookmarked ? R.attr.colorError : R.attr.colorPrimary,
											0)));
				});
	...
	private void openBranchPicker(String type) {
		BranchPickerBottomSheet branchPicker =
	...
	private void openReviewersPicker() {
		...
		AssigneesPickerBottomSheet reviewersPicker =
				AssigneesPickerBottomSheet.newInstance(
