 ...
 * @author mmarif
 */
public class IssuesFilterBottomSheet extends BottomSheetDialogFragment {
	...
	public static IssuesFilterBottomSheet newInstance(RepositoryContext repository) {
		IssuesFilterBottomSheet f = new IssuesFilterBottomSheet();
	...
	private void showLabelPicker() {
		LabelPickerBottomSheet picker =
				LabelPickerBottomSheet.newInstance(repository, filterState.selectedLabels);
	...
	private void showMilestonePicker() {
		...
		MilestonePickerBottomSheet picker =
				MilestonePickerBottomSheet.newInstance(repository, current);
