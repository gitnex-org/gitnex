...
public class CreateFileBottomSheet extends BottomSheetDialogFragment {
	...
	public static CreateFileBottomSheet newInstance(
		...
		CreateFileBottomSheet fragment = new CreateFileBottomSheet();
		...
		binding.btnBookmark.setOnClickListener(
				v -> {
					...
					BookmarkHelper.toggleBookmark(
							...
							null,
							null,
							getString(R.string.pageTitleNewFile)
									+ " · "
									+ repoContext.getFullName(),
	...
	private void openCreateBranch() {
		CreateBranchBottomSheet createBranch =
				CreateBranchBottomSheet.newInstance(
						repoContext.getOwner(), repoContext.getName(), selectedBranch);
	...
	private void openFullScreenEditor() {
		...
		EditorBottomSheet.EditorMode mode =
				fileName.endsWith(".md")
						? EditorBottomSheet.EditorMode.MARKDOWN
						: EditorBottomSheet.EditorMode.CODE;

		EditorBottomSheet editor =
				EditorBottomSheet.newInstance(content, repoContext, mode, extension);
	...
	private void openPullRequestSheet(String pullFromBranch, String title) {
		...
		CreatePullRequestBottomSheet prSheet =
				CreatePullRequestBottomSheet.newInstance(
