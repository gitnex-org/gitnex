 ...
 * @author mmarif
 */
public class DependenciesBottomSheet extends BottomSheetDialogFragment {
	...
	public static DependenciesBottomSheet newInstance(String owner, String repo, long issueIndex) {
		DependenciesBottomSheet sheet = new DependenciesBottomSheet();
