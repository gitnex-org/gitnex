 ...
 * @author mmarif
 */
public class AssigneesPickerBottomSheet extends BottomSheetDialogFragment {
	...
	public static AssigneesPickerBottomSheet newInstance(
			RepositoryContext repo, List<String> current, @Nullable String excludeUser) {
		AssigneesPickerBottomSheet f = new AssigneesPickerBottomSheet();
