 ...
 * @author mmarif
 */
public class BranchPickerBottomSheet extends BottomSheetDialogFragment {
	...
	public static BranchPickerBottomSheet newInstance(String owner, String repo, String current) {
		BranchPickerBottomSheet fragment = new BranchPickerBottomSheet();
