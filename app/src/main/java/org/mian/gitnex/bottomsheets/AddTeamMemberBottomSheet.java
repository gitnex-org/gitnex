 ...
 * @author mmarif
 */
public class AddTeamMemberBottomSheet extends BottomSheetDialogFragment {
	...
	public static AddTeamMemberBottomSheet newInstance(long teamId) {
		AddTeamMemberBottomSheet fragment = new AddTeamMemberBottomSheet();
