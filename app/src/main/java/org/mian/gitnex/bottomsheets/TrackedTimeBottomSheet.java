 ...
 * @author mmarif
 */
public class TrackedTimeBottomSheet extends BottomSheetDialogFragment {
	...
	public static TrackedTimeBottomSheet newInstance(String owner, String repo, long issueIndex) {
		TrackedTimeBottomSheet sheet = new TrackedTimeBottomSheet();
