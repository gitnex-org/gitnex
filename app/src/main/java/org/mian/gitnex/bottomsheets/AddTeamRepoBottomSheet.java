 ...
 * @author mmarif
 */
public class AddTeamRepoBottomSheet extends BottomSheetDialogFragment {
	...
	public static AddTeamRepoBottomSheet newInstance(long teamId, String orgName) {
		AddTeamRepoBottomSheet fragment = new AddTeamRepoBottomSheet();
