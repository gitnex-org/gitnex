 ...
 * @author mmarif
 */
public class PrActionsBottomSheet extends BottomSheetDialogFragment {
	...
	public static PrActionsBottomSheet newInstance(
			String owner, String repo, long prNumber, PullRequest pullRequest) {
		PrActionsBottomSheet sheet = new PrActionsBottomSheet();
