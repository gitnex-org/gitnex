...
public class CreateBranchBottomSheet extends BottomSheetDialogFragment {
	...
	public static CreateBranchBottomSheet newInstance(String owner, String repo, String sourceRef) {
		CreateBranchBottomSheet fragment = new CreateBranchBottomSheet();
