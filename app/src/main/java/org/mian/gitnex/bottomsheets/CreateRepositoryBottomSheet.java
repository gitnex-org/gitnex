 ...
 * @author mmarif
 */
public class CreateRepositoryBottomSheet extends BottomSheetDialogFragment {
	...
	public static CreateRepositoryBottomSheet newInstance(String owner, boolean isOrg) {
		CreateRepositoryBottomSheet fragment = new CreateRepositoryBottomSheet();
