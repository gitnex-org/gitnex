 ...
 * @author mmarif
 */
public class CreateOrganizationBottomSheet extends BottomSheetDialogFragment {

	private BottomsheetCreateOrganizationBinding binding;
	private OrganizationsViewModel viewModel;

	public static CreateOrganizationBottomSheet newInstance() {
		return new CreateOrganizationBottomSheet();
	}
