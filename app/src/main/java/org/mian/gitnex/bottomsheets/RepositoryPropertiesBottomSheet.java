 ...
 * @author mmarif
 */
public class RepositoryPropertiesBottomSheet extends BottomSheetDialogFragment {
	...
	public static RepositoryPropertiesBottomSheet newInstance(String owner, String repoName) {
		RepositoryPropertiesBottomSheet fragment = new RepositoryPropertiesBottomSheet();
