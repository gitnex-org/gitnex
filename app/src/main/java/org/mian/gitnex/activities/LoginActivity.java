...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void login() {
        ...
        if(loginUid.contains(":")) {
            ...
            String[] usernameWithOTP = loginUid.split(":");

            if(usernameWithOTP.length == 2 ) {

                loginUid = usernameWithOTP[0];
                loginOTP = Integer.valueOf(usernameWithOTP[1]);

            }
            else {

                Toasty.info(getApplicationContext(), getString(R.string.loginOTPError));
        ...
        if(connToInternet) {
            ...
            if(instance_url.getText().toString().equals("") || loginUid.equals("") ||
