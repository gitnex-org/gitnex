...
public class CreateIssueActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private EditText newIssueDescription;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getMilestones(instanceUrl, instanceToken, repoOwner, repoName);

        getLabels(instanceUrl, instanceToken, repoOwner, repoName);
        getCollaborators(instanceUrl, instanceToken, repoOwner, repoName);
    ...
    private void createNewIssueFunc(final String instanceUrl, final String token, String repoOwner, String repoName, String loginUid, String newIssueDescriptionForm, String newIssueDueDateForm, int newIssueMilestoneIdForm, String newIssueTitleForm, List<String> newIssueAssigneesListForm, int[] newIssueLabelsForm) {
        ...
        call3 = RetrofitClient
                ...
                .getApiInterface()
                .createNewIssue(token, repoOwner, repoName, createNewIssueJson);
    ...
    private void getMilestones(String instanceUrl, String instanceToken, String repoOwner, String repoName) {

        Call<List<Milestones>> call = RetrofitClient
                .getInstance(instanceUrl)
                .getApiInterface()
                .getMilestones(instanceToken, repoOwner, repoName);
    ...
    private void getCollaborators(String instanceUrl, String instanceToken, String repoOwner, String repoName) {
    ...
    private void getLabels(String instanceUrl, String instanceToken, String repoOwner, String repoName) {
