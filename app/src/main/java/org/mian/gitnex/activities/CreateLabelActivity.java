...
public class CreateLabelActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().getStringExtra("labelAction") != null && getIntent().getStringExtra("labelAction").equals("delete")) {
            ...
            deleteLabel(instanceUrl, instanceToken, repoOwner, repoName, Integer.valueOf(getIntent().getStringExtra("labelId")));
            finish();
            return;
        ...
        Button createLabelButton = findViewById(R.id.createLabelButton);
    ...
    private void processUpdateLabel() {
        ...
        patchLabel(instanceUrl, instanceToken, repoOwner, repoName, updateLabelName, updateLabelColor, Integer.valueOf(getIntent().getStringExtra("labelId")));
    ...
    private void processCreateLabel() {
        ...
        createNewLabel(instanceUrl, instanceToken, repoOwner, repoName, newLabelName, newLabelColor);

    }

    private void createNewLabel(final String instanceUrl, final String token, String repoOwner, String repoName, String newLabelName, String newLabelColor) {
        ...
        call = RetrofitClient
                ...
                .getApiInterface()
                .createLabel(token, repoOwner, repoName, createLabelFunc);
    ...
    private void patchLabel(final String instanceUrl, final String token, String repoOwner, String repoName, String updateLabelName, String updateLabelColor, int labelId) {
        ...
        call = RetrofitClient
                .getInstance(instanceUrl)
                .getApiInterface()
                .patchLabel(token, repoOwner, repoName, labelId, createLabelFunc);
    ...
    private void deleteLabel(final String instanceUrl, final String token, final String repoOwner, final String repoName, int labelId) {
        ...
        call = RetrofitClient
                .getInstance(instanceUrl)
                .getApiInterface()
                .deleteLabel(token, repoOwner, repoName, labelId);
            ...
            public void onResponse(@NonNull Call<Labels> call, @NonNull retrofit2.Response<Labels> response) {
                ...
                if(response.isSuccessful()) {
                    if(response.code() == 204) {
                        ...
                        LabelsViewModel.loadLabelsList(instanceUrl, token, repoOwner, repoName);
                        getIntent().removeExtra("labelAction");
                        getIntent().removeExtra("labelId");
